...
{: .home-title .d-flex .flex-justify-around	 }
para aprobar la asignatura es necesario realizar un [trabajo practico integrador]({% link trabajo_actual/index.md %}) en el cual se implementan todos los conocimientos adquiridos durante la cursada y un parcial teorico practico.
